...
static void printHitsAndFaults(char *reference_string, int frames)
{
    ...
    // Initialize second_chance array to false
    for (i = 0; i < frames; i++)
    {
...
int main()
{
    printf("lab 7.5(second chance page refreshment algorithm:)\n");
    printf("Name:Nisha Lamichhane\n");
    printf("Roll no:21 \t\t\t section:'A:\n");
    char reference_string[] = "0 3 9 5 2 8 7 6 5 7 4 4 8 4 4 7 3 4";
    int frames = 3;
